...
import { TrendingUp, Users, Database, Lock, BarChart3, Zap } from 'lucide-react';
...
export function KpiStrip({ stats, stakerRatio, veByndSupplyNum }: KpiStripProps) {
  const cards = [
      ...
      {cards.map((c, i) => {
        ...
        return (
          ...
          >
            ...
            <p className={`text-xl lg:text-2xl font-black truncate ${isBoost ? 'text-acid' : 'text-silver'}`}>
              {c.value}
            </p>
