      ...
      },
      {
        ...
        blocks: [
          ...
          steps([
            ...
            { title: 'Harvest & distribute', body: 'Once the epoch\'s gauges have paid out, call `harvestAndDistribute()`. This is the step that pays you a bounty: 1% of every token swept. It also closes the epoch out, which is what re-arms all of the above for the next one.' },
          ]),
