...
import { Logo, PixelArt } from "@/components/ui";
import { DiscordIcon, TelegramIcon, XIcon } from "@/components/ui/BrandIcons";
import mascotFlagWebp from "@/assets/illustrations/mascot/mascot-flag-plant.webp";
import mascotFlagPng from "@/assets/illustrations/mascot/mascot-flag-plant.png";
import mascotSleepingWebp from "@/assets/illustrations/mascot/mascot-sleeping.webp";
import mascotSleepingPng from "@/assets/illustrations/mascot/mascot-sleeping.png";
import iconChestWebp from "@/assets/illustrations/icons/icon-chest.webp";
import iconChestPng from "@/assets/illustrations/icons/icon-chest.png";
import iconFlagWebp from "@/assets/illustrations/icons/icon-flag-bynd.webp";
import iconFlagPng from "@/assets/illustrations/icons/icon-flag-bynd.png";
        ...
        <div className="mx-auto flex max-w-[1120px] flex-col items-center gap-[30px] px-5 text-center">
          <div className="flex items-center gap-4">
            <PixelArt
              ...
              height={226}
              alt=""
              className="h-7 w-auto opacity-70 motion-safe:animate-illo-float"
            />
            <PixelArt
              webp={mascotFlagWebp}
              png={mascotFlagPng}
              width={359}
              height={420}
              alt="The BYND mascot planting a flag"
              className="h-[100px] w-auto motion-safe:animate-illo-bob"
            />
            <PixelArt
              webp={iconFlagWebp}
              png={iconFlagPng}
              ...
              height={240}
              alt=""
              className="h-7 w-auto opacity-70 motion-safe:animate-illo-float [animation-delay:.6s]"
            />
          </div>
          ...
          <p className="flex items-center gap-2 text-[13px] text-white/[.38]">
            © 2026 Bynd Protocol. Liquid governance for Mezo.
            <PixelArt
              webp={mascotSleepingWebp}
              png={mascotSleepingPng}
              width={386}
              height={420}
              alt=""
