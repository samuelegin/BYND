...
export interface VeBYNDInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BURNER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface VeBYND extends BaseContract {
  connect(runner?: ContractRunner | null): VeBYND;
  waitForDeployment(): Promise<this>;

  interface: VeBYNDInterface;
