...
export const ConnectModal: React.FC<ConnectModalProps> = ({
  ...
  const wallets = [
    ...
    { id: 'xverse', name: 'Xverse', description: 'Xverse Bitcoin wallet (Mezo Passport compatible)', icon: '🟢' },
    { id: 'unisat', name: 'UniSat', description: 'UniSat wallet (on-chain ordinals & BTC tools)', icon: '🧭' },
    { id: 'okx', name: 'OKX Wallet', description: 'OKX browser/mobile wallet via injected or WalletConnect', icon: '🟣' },
    { id: 'walletconnect', name: 'WalletConnect', description: 'Connect mobile wallets via WalletConnect', icon: '🔗' },
  ];
